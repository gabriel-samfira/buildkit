...
// I am unsure what the available flags are for BfGetMappings(), but for now, using 0x00000001 seems to return all mappings
// created on a particular volume.
const (
...
func GetBindMappings(volumePath string) ([]BindMapping, error) {
	...
	var flags uint32 = BINDFLT_FLAG_READ_ONLY_MAPPING
